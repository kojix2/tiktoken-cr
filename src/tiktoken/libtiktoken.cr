module Tiktoken
  ...
  lib LibTiktoken
    ...
    fun tiktoken_num_tokens_from_messages(model : LibC::Char*, num_messages : UInt32, messages : CChatCompletionRequestMessage*) : LibC::SizeT
    fun tiktoken_get_chat_completion_max_tokens(model : LibC::Char*, num_messages : UInt32, messages : CChatCompletionRequestMessage*) : LibC::SizeT
